...
class TestClient(unittest.TestCase):
    ...
    def test_search_string_exists(self, mock_context, mock_create_connection):
        ...
        for search in found_search:
        #test for string_query_search to see if it  finds string
            result = client.string_query_search(search)
    ...
    def test_search_string_not_exists(self,
        ...
        search_not_found = "this;search;is;invalid;"
        #test for string_query_search to see if it does not find string
        result = client.string_query_search(search_not_found)
